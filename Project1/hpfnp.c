...
/*
// function to compare priority and arival time for hpf non-preemptive
int compare_priority(void * data1, void * data2)
{
...
//testing
// function to print contents of queue during hpf non-preemptive
void printqueue(queue * q)
{
  if (q->head != NULL)
  {
...
*/
// Implementation of hpf non-preemptive

average_stats highest_priority_first_np(linked_list * processes)
{
  int t = 0; // quanta declearation
  // creation of a processes using create_queue
  ...
  {
    //check for new incoming process and enqueue it
    ...
    printf("The average statistics HPF Non-Preemptive considering all priority queues is:\n");
